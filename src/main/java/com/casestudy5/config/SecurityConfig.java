    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors(httpSecurityCorsConfigurer -> {
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/products/all","api/products/view/**","api/products/category","api/products/filter-by-price","api/products/related/**").permitAll()
                        ...
                        .requestMatchers("/api/revenue/**").hasAnyAuthority("ROLE_SELLER")
                )
